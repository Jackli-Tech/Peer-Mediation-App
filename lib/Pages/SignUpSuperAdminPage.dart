...
class SignUpSuperAdminPage extends StatefulWidget {
  @override
  _SignUpSuperAdminPageState createState() => _SignUpSuperAdminPageState();
}

class _SignUpSuperAdminPageState extends State<SignUpSuperAdminPage> {
  bool vis = true;
